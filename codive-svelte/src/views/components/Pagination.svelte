...
<span class='pagination'>
    ...
    <span class='pagination-btns'>
        <button class='pagination-btn' disabled={activeSlide === 0} on:click={prevSlide} title='Previous Step'>←</button>
        <button class='pagination-btn' disabled={activeSlide === count - 1} on:click={nextSlide} title='Next Step'>→</button>
        <button class='pagination-live-btn' class:live={isLiveSlide} on:click={goToLiveSlide} title='Enable Live'>
