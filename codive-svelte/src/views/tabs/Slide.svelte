<script>
    ...
    const itemClicked = ({ liveP, activeSlide }) => dispatch('liveSlideChange', {
        liveP,
    ...
    function displaySelection(options) {
        ...
        console.log(`DisplaySelection called with isHost=${isHost}, isLiveSlide=${isLiveSlide}, activeSlide=${activeSlide}, liveP=${liveP}`);
...
<style>
    ...
    :global(.isHost .slide-content > ul:hover, .isHost .slide-content > ol:hover) {
        padding-left: calc(2em - 4px);
    }
